...
const AllData = ({ city, setWeatherData, setForecastData, setAirPollutionData }) => {
  useEffect(() => {
    if (city) {
      axios
        .get(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=463bce9969af3f76b2c3f7ddecd37e80`)
        .then((response) => {
          ...
          axios
            .get(`https://api.openweathermap.org/data/2.5/air_pollution?lat=${lat}&lon=${lon}&appid=463bce9969af3f76b2c3f7ddecd37e80`)
            .then((response) => {
